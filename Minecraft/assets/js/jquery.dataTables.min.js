...
(function (i, wa, p) {
      ...
      fnUpdate: function (g, l) {
        if (g.aanFeatures.p) {
          ...
          for (r = s; r <= x; r++)
            G +=
              y != r
                ? '<span class="' + v.sPageButton + '">' + r + "</span>"
                : '<span class="' + v.sPageButtonActive + '">' + r + "</span>";
          x = g.aanFeatures.p;
          var z,
            Y = function (L) {
  ...
  i.fn.dataTable = function (g) {
    ...
    function r(a) {
      return function () {
        var b = [A(this[o.iApiIndex])].concat(
    ...
    function Sa(a, b, c, d, f) {
      ...
      e = 9999999999999;
      if (
        (ta(a) !== null ? p.cookie.length : b.length + p.cookie.length) + 10 >
        4096
      ) {
        a = p.cookie.split(";");
    ...
    this.fnFilter = function (a, b, c, d, f) {
      ...
      if (e.oFeatures.bFilter) {
        ...
        if (typeof b == "undefined" || b === null) {
          M(e, { sSearch: a, bRegex: c, bSmart: d }, 1);
    ...
    this.fnDestroy = function () {
      ...
      if (a.bJUI) {
        i("th", a.nTHead).removeClass(
          [
            o.oStdClasses.sSortable,
            o.oJUIClasses.sSortableAsc,
            o.oJUIClasses.sSortableDesc,
            o.oJUIClasses.sSortableNone,
          ].join(" ")
        );
        ...
        i("th", a.nTHead).removeClass(
          [
            o.oStdClasses.sSortable,
            o.oStdClasses.sSortableAsc,
            o.oStdClasses.sSortableDesc,
            o.oStdClasses.sSortableNone,
          ].join(" ")
        );
        ...
        if (typeof g != "undefined" && g !== null) {
          ...
          if (
            ...
            e.oFeatures.bDeferRender &&
              e.aoDrawCallback.push({ fn: T, sName: "defer_sort_classes" });
